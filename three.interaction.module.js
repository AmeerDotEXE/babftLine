import { EventDispatcher, Object3D, Raycaster, Vector2 } from 'https://unpkg.com/three@0.160.0/build/three.module.js';
...
var InteractionManager = function (_EventDispatcher) {
  ...
  function InteractionManager(renderer, scene, camera, options) {
    ...
    // console.log(InteractionManager.__proto__)
    // console.log(Object.getPrototypeOf(InteractionManager))
